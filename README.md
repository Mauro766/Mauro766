...
| 🔭&nbsp; Ahora mismo | 📚&nbsp; Estudiando | 🎨&nbsp; Explorando |
|:---|:---|:---|
| Ecommerce full stack | Bases de Datos II | Three.js & GSAP |
| Spring Boot + React | (SQL Server) | Diseño web 3D |
| Mercado Pago + WebSockets | Auditoría de Sistemas (COBIT) | Animaciones scroll-driven |
